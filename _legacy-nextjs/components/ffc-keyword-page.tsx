...
export default function FFCKeywordPage({ service, keyword }: KeywordPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-amber-50 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm flex-wrap">
            ...
            <ChevronRight className="h-4 w-4 text-gray-400" />
            <Link href={`/${service.slug}`} className="text-gray-500 hover:text-rose-800">{service.name}</Link>
            <ChevronRight className="h-4 w-4 text-gray-400" />
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12">
                ...
                <div className="text-center mt-6">
                  <Link href="/packages">
                    <Button variant="outline" className="border-rose-800 text-rose-800 hover:bg-amber-50">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
            {vadodaraAreas.slice(0, 12).map((area) => (
              <Link 
                key={area.slug}
                href={`/${area.slug}`}
                className="px-4 py-2 bg-amber-50 rounded-full text-gray-700 hover:bg-rose-800 hover:text-white transition-colors border border-amber-200 text-sm"
              >
                {area.name}
              </Link>
            ))}
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-br from-rose-800 to-amber-600 text-white">
