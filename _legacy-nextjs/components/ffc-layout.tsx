...
const serviceLinks = [
  { name: 'Anniversary Dinner', href: '/anniversary-dinner-vadodara' },
  { name: 'Anniversary Decoration', href: '/anniversary-decoration-vadodara' },
  { name: 'Anniversary Surprise', href: '/anniversary-surprise-for-wife-vadodara' },
  { name: 'Wedding Anniversary Party', href: '/wedding-anniversary-party-vadodara' },
  { name: '25th Anniversary', href: '/25th-anniversary-celebration-vadodara' },
  { name: 'Rooftop Anniversary', href: '/rooftop-anniversary-vadodara' },
];
...
export function FFCFooter() {
  ...
  // Get all anniversary keywords
  const allKeywords = anniversaryKeywords;
  
  // Display first 10 keywords initially, all when expanded
  const visibleKeywords = showAllKeywords ? allKeywords : allKeywords.slice(0, 10);
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <h4 className="text-sm font-semibold text-gray-400 mb-4 uppercase tracking-wider">Anniversary Services in Vadodara</h4>
