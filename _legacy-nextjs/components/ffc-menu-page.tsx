...
export default function FFCMenuPage() {
  return (
    <div className="min-h-screen bg-white">
              ...
              {menuItems.addOns.map((item, index) => (
                <Card key={index} className="border-amber-100 bg-amber-50">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-rose-800 font-bold text-lg">{item.price}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-rose-800" />
            ...
            <Card className="border-amber-200">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-full bg-amber-100 flex items-center justify-center">
                    <Utensils className="h-6 w-6 text-rose-800" />
                  </div>
            ...
            <Card className="border-amber-200">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-full bg-amber-100 flex items-center justify-center">
                    <Gift className="h-6 w-6 text-rose-800" />
                  </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-rose-800 to-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <FFCBookNowButton pageTitle="Menu Page" className="text-lg px-8 py-6 bg-white text-rose-800 hover:bg-amber-50" />
