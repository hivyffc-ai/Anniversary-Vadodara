...
import { FFCBookingFormInner, FFCWhatsAppFloat } from '@/components/ffc-booking-form';
import { SetupPackage, packages, formatPrice, siteConfig } from '@/lib/anniversary-config';
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12">
            ...
            <div className="mt-4 lg:mt-0">
              {/* Title & Tagline */}
              <Badge className="mb-3 md:mb-4 bg-amber-100 text-rose-900 border-amber-200">
              ...
              <div className="mb-6 md:mb-8">
                <FFCBookingFormInner variant="sidebar" packageName={pkg.name} defaultPackageSlug={pkg.slug} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={`rounded-xl p-4 md:p-6 text-center ${pkg.cakeIncluded ? 'bg-gradient-to-br from-green-100 to-emerald-100 border-2 border-green-200' : 'bg-gradient-to-br from-amber-100 to-amber-100'}`}>
              ...
              <div className="bg-gradient-to-br from-amber-100 to-amber-100 rounded-xl p-4 md:p-6 text-center">
            ...
            {relatedPackages.map((relPkg) => (
              <Link key={relPkg.id} href={`/packages/${relPkg.slug}`}>
                <Card className="h-full hover:shadow-lg transition-all hover:-translate-y-1 border-amber-100 group">
                  <div className="aspect-square md:aspect-video bg-gradient-to-br from-amber-100 to-amber-100 relative overflow-hidden">
                    <Image
