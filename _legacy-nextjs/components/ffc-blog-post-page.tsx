        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <Badge className="bg-amber-100 text-rose-900">
                {post.category}
              </Badge>
            ...
            {/* Share & CTA */}
            <div className="mt-10 p-6 bg-gradient-to-r from-amber-50 to-amber-50 rounded-2xl">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                  <Button 
                    className="bg-gradient-to-r from-rose-800 to-amber-600 hover:from-rose-900 hover:to-amber-700"
                    asChild
                  >
                  ...
                  <Button 
                    variant="outline"
                    className="border-rose-800 text-rose-800 hover:bg-amber-50"
                    asChild
                  >
