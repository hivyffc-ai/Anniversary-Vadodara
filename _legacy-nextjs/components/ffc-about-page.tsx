        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-6">
                <Link href="/contact">
                  <Button className="bg-gradient-to-r from-rose-800 to-amber-600 hover:from-rose-900 hover:to-amber-700 text-white">
            ...
            <div className="order-1 lg:order-2">
              <div className="aspect-[4/3] bg-gradient-to-br from-amber-100 to-amber-100 rounded-2xl overflow-hidden relative shadow-xl">
                <Image
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`tel:${siteConfig.phone}`}>
              <Button size="lg" className="bg-gradient-to-r from-rose-800 to-amber-600 hover:from-rose-900 hover:to-amber-700 text-white w-full sm:w-auto">
