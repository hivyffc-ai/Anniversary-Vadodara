...
export default function FFCBlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 bg-gradient-to-br from-amber-50 via-amber-50 to-amber-100">
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <CardContent className="p-8 flex flex-col justify-center">
                  ...
                  <Button className="w-fit bg-gradient-to-r from-rose-800 to-amber-600 hover:from-rose-900 hover:to-amber-700">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-rose-800 to-amber-600">
