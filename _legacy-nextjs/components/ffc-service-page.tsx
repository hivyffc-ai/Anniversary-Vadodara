            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href={`tel:${siteConfig.phone}`}>
                  <Button size="lg" className="bg-white text-rose-800 hover:bg-amber-50 w-full sm:w-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
            {vadodaraAreas.slice(0, 15).map((area) => (
              <Link 
                key={area.slug}
                href={`/${area.slug}`}
                className="px-4 py-2 bg-white rounded-full text-gray-700 hover:bg-rose-800 hover:text-white transition-colors border border-amber-200 text-sm"
              >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div>
              <FFCBookingFormInner pageTitle={`${service.name} Page`} />
            </div>
          </div>
        </div>
      </section>
